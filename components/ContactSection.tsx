...
export default function ContactSection() {
  ...
  return <section ref={scope} id="contact" className="relative z-10 h-[165vh] bg-navy">
    <div className="sticky top-0 h-screen overflow-hidden">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=2400&q=90')" }} />
      ...
      <div data-contact-content className="relative mx-auto flex h-full max-w-[1440px] items-start px-6 pt-32 text-white lg:px-12 lg:pt-40">
        <div className="grid w-full gap-10 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <a href="mailto:info@prideengineeringllc.com" className="btn-fill group mt-8 inline-flex items-center gap-3 border border-gold bg-gold px-6 py-3 text-xs font-semibold uppercase tracking-[.18em] text-white transition-colors duration-500 hover:text-gold">
          ...
          <p className="hidden border-l border-white/35 pl-5 pt-2 text-sm leading-relaxed text-white/70 lg:block lg:col-span-2">Dubai, United Arab Emirates<br />+971 4 000 0000</p>
        </div>
      </div>
    </div>
  </section>;
